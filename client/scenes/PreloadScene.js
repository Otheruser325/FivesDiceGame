export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
		...
		this.load.audio('hero_time', 'assets/audio/hero_time.mp3');
        this.load.audio('energy', 'assets/audio/energy.mp3');
        this.load.audio('powerhouse', 'assets/audio/powerhouse.mp3');
    }
